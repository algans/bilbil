...
const ANSWER_META = [
  {
    icon: TriangleIcon,
    name: "Kırmızı üçgen",
    iconColor: "text-a-red",
    accent: "accent-a-red",
    bgSoft: "bg-a-red/10",
    borderSoft: "border-a-red/30",
    borderActive: "border-a-red",
  },
  {
    icon: DiamondIcon,
    name: "Mavi elmas",
    iconColor: "text-a-blue",
    accent: "accent-a-blue",
    bgSoft: "bg-a-blue/10",
    borderSoft: "border-a-blue/30",
    borderActive: "border-a-blue",
  },
  {
    icon: CircleIcon,
    name: "Sarı daire",
    iconColor: "text-a-yellow",
    accent: "accent-a-yellow",
    bgSoft: "bg-a-yellow/10",
    borderSoft: "border-a-yellow/30",
    borderActive: "border-a-yellow",
  },
  {
    icon: SquareIcon,
    name: "Yeşil kare",
    iconColor: "text-a-green",
    accent: "accent-a-green",
    bgSoft: "bg-a-green/10",
    borderSoft: "border-a-green/30",
    borderActive: "border-a-green",
  },
] as const;
